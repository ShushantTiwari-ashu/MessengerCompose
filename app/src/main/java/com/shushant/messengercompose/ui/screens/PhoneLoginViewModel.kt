...
import com.shushant.messengercompose.extensions.connectedOrThrow
import com.shushant.messengercompose.extensions.isDarkTheme
import com.shushant.messengercompose.extensions.isSystemDarkMode
...
class PhoneLoginViewModel(
    ...
    private val authRepository: MessengerRepository
) : ViewModel() {
