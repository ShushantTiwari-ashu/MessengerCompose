...
class RTCAudioManager(context: Context) {
    ...
    private inner class WiredHeadsetReceiver() : BroadcastReceiver() {
        override fun onReceive(context: Context?, intent: Intent) {
            ...
            Timber.d("WiredHeadsetReceiver.onReceive" + ": " + "a=" + intent.action.toString() + ", s=" + (if (state == STATE_UNPLUGGED) "unplugged" else "plugged").toString() + ", m=" + (if (microphone == HAS_MIC) "mic" else "no mic").toString() + ", n=" + name.toString() + ", sb=" + isInitialStickyBroadcast)
...
//        }
    ...
    fun updateAudioDeviceState() {
        ThreadUtils.checkIsOnMainThread()
        Timber.d(("--- updateAudioDeviceState: wired headset=$hasWiredHeadset"))
    ...
    init {
        ...
        Timber.d("useSpeakerphone: $useSpeakerphone")
