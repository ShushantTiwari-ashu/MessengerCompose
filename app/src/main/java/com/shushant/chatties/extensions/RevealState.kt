...
fun RevealSwipe(
    ...
    backgroundCardStartColor: Color = Color.White,
    backgroundCardEndColor: Color = Color.White,
    backgroundCardContentColor: Color = Color.White,
            ...
            Row(
                ...
                Row(
                    modifier = Modifier
                        .fillMaxWidth(0.5f)
                        .fillMaxHeight()
                        .background(if (directions.contains(RevealDirection.StartToEnd)) Color.White else Color.White)
                ...
                Row(
                    modifier = Modifier
                        .fillMaxWidth(1f)
                        .fillMaxHeight()
                        .background(if (directions.contains(RevealDirection.EndToStart)) Color.White else Color.White)
